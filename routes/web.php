...
Route::post('/check-valid-email', [AuthController::class, 'checkValidEmail'])->middleware('guest');
Route::get('/reset-password', [AuthController::class, 'resetPasswordView'])->middleware('guest');
